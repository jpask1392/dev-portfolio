...
import { TitleInput, ImageInput, TextInput, GistInput } from "./inputTypes.jsx"
...
const AddNewProject = props => {
	...
	const onSelect = () => {
		const sectionTypeOptions = document.getElementById("sectionTypeSel")
			.options
		...
		<div className='new-project-form-container'>
			...
			<form id='newProjectForm' method='POST'>
				<dl>
					...
					<dd>
						<input name='mainImagePath'></input>
					</dd>
					<dt>Postition</dt>
					<dd>
					...
					{sectionOptions ? (
						<button type='button' onClick={() => updateSections()}>
							OK
						</button>
					) : (
						<button
