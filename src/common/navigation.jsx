		...
		return (
			<div id='nav-container'>
				<nav>
					...
					<ul
						className={
							this.state.navClicked ? "full-page-nav-visible" : ""
						}>
						<span>
...
const BurgerIcon = props => (
	<div id='burger-icon' onClick={() => props.clickFunction()}>
		<span
			...
			className={
				"burger-icon-line-one" + (props.active ? "-active" : "")
			}></span>
		<span
			style={{ background: props.burgerColor }}
			className={
				"burger-icon-line-two" + (props.active ? "-active" : "")
			}></span>
		<span
			style={{ background: props.burgerColor }}
			className={
				"burger-icon-line-three" + (props.active ? "-active" : "")
			}></span>
	</div>
)
